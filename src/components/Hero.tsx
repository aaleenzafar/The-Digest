...
export function Hero() {
  return (
    <section id="top" className="relative text-white px-4 md:px-12 lg:px-16 pt-20 md:pt-24 pb-10 md:pb-12 lg:pb-16 min-h-screen flex flex-col justify-end lg:grid lg:grid-cols-2 lg:items-center lg:min-h-screen">
        ...
        <div>
          <div style={{ letterSpacing: '-0.04em' }}>
            <AnimatedHeading
              ...
              className="text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-normal mb-3 md:mb-4 leading-tight"
            />
          </div>

          <FadeIn delay={800}>
            <p className="text-sm md:text-base lg:text-lg text-gray-300 mb-4 md:mb-5 leading-relaxed max-w-xl">
      ...
      <FadeIn delay={1400}>
        <div className="hidden lg:flex justify-end">
          <div className="liquid-glass border border-white/20 px-4 md:px-6 py-2 md:py-3 rounded-xl inline-block">
